 ...
 * @author asilkaratas
 */
public class HighPassFilterView extends VBox
{
    
    private ConvolutionFilter highPassFilter;
    public HighPassFilterView()
    {
        int[] kernel = {
            -1, -1, -1,
            -1, 9, -1,
        ...
        highPassFilter = new ConvolutionFilter("High Pass", kernel, 1, 0);
    ...
    private void update()
    {
        ...
        BufferedImage out = highPassFilter.apply(in);
